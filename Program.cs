...
namespace QuanLyDT
{
    internal class Program
    {
        ...
        static void Main()
        {
            ...
            DienThoaiChiTiet dtct1 = new DienThoaiChiTiet("DT01", "iPhone 13", "Apple", "128GB", "Blue", 10, 25000000, true);
            DanhSachDienThoaiChiTiet.Add(dtct1);

            DienThoai dt2 = new DienThoai("DT02", "Galaxy S24", "Samsung");
            DanhSachDienThoai.Add(dt2);
            DienThoaiChiTiet dtct2 = new DienThoaiChiTiet("DT02", "Galaxy S24", "Samsung", "256GB", "Black", 8, 23000000, true);
            DanhSachDienThoaiChiTiet.Add(dtct2);

            DienThoai dt3 = new DienThoai("DT03", "Rog phone 7", "Asus");
            DanhSachDienThoai.Add(dt3);
            DienThoaiChiTiet dtct3 = new DienThoaiChiTiet("DT03", "ROG Phone 7", "ASUS", "512GB", "White", 5, 20000000, false);
